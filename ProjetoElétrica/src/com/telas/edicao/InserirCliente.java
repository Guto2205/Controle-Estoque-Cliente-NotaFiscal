...
public class InserirCliente extends JFrame {
	...
	private static final long serialVersionUID = 1L;
		...
		public void criaJanela() {
			...
			lbNome.setBounds(0, 30, 267, 29);
			lbTelefone = new JLabel("         Telefone.:");
			lbTelefone.setBounds(0, 60, 267, 29);
			lbRua = new JLabel("         Rua.:");
			lbRua.setBounds(0, 90, 267, 29);
			lbNumero = new JLabel("         Numero.:");
			lbNumero.setBounds(0, 120, 267, 29);
			lbBairro = new JLabel("         Bairro.:");
			lbBairro.setBounds(0, 150, 267, 29);
			lbComplemento = new JLabel("         Complemento.:");
			lbComplemento.setBounds(0, 180, 267, 29);
			...
			btSalvar.addActionListener(new InserirCliente.BtSalvarListener());
			btLimpar.addActionListener(new InserirCliente.BtLimparListener());
		}
